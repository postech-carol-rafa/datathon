...
# Dataframe Resumidos e ajustando e criando colunas
...
## Área com a quantidade de vagas nos últimos meses e vagas por divisão da divison
...
with col1:
   ...
   fig1.update_traces(
    ...
    hovertemplate='<span style="font-weight:normal;">Período: %{x}</span><br><b>Valor: %{y}</b><extra></extra>'
    )
